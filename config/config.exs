...
config :spider_pig, SpiderPigWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: SpiderPigWeb.ErrorHTML, json: SpiderPigWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: SpiderPig.PubSub,
  live_view: [signing_salt: "tyGweRqd"]
...
config :spider_pig, SpiderPig.Mailer, adapter: Swoosh.Adapters.Local
