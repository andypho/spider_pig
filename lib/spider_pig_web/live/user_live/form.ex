defmodule SpiderPigWeb.UserLive.Form do
  use SpiderPigWeb, :live_view

  alias SpiderPig.Accounts
  alias SpiderPig.Accounts.User
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash}>
      ...
      <.form for={@form} id="user-form" phx-change="validate" phx-submit="save">
        ...
        <footer>
          <.button phx-disable-with="Saving..." variant="primary" type="submit">Save User</.button>
