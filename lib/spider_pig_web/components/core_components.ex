defmodule SpiderPigWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SpiderPigWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SpiderPigWeb.Gettext, "errors", msg, opts)
    end
  end
